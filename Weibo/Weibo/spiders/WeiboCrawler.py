...
from ..items import TweetsItem, InformationItem, RelationshipsItem, CommentItem
...
class WeiboSpider(Spider):
    ...
    def start_requests(self):
        ...
        yield Request(url="https://weibo.cn/search/mblog?hideSearchFrame=&keyword=%E8%82%BA%E7%82%8E&page=1",
